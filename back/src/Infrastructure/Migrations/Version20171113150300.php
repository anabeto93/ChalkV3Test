...
class Version20171113150300 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE user_session_quiz_result (user_id INT NOT NULL, session_id INT NOT NULL, correct_answers_number INT NOT NULL, questions_number INT NOT NULL, medium VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_28B4404FA76ED395 (user_id), INDEX IDX_28B4404F613FECDF (session_id), PRIMARY KEY(user_id, session_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
