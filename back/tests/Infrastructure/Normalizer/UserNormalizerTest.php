...
class UserNormalizerTest extends TestCase
{
    ...
    public function dataProvider(): array
    {
        return [
            [
                new User('uuid-user', 'Jean', 'Paul', '+33123123123', 'FR', 'fr', 34, 'token', new \DateTime(), false),
                [
                    'uuid' => 'uuid-user',
                    'firstName' => 'Jean',
                    'lastName' => 'Paul',
            ...
            [
                new User('Other-UUID', 'TRUC', 'Muche', '+33987987987', 'FR', 'fr', 34, 'token', new \DateTime(), false),
                [
                    'uuid' => 'Other-UUID',
                    'firstName' => 'TRUC',
                    'lastName' => 'Muche',
